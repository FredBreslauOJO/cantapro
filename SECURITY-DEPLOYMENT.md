...
Configure no ambiente de produção: `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET` e `APP_URL=https://www.canta.pro`. Os Price IDs reais já estão definidos para Base (R$4,99) e Pro (R$7,99); em staging, substitua-os pelos preços de teste correspondentes.
